...
namespace StarFox.Interop.MAP
{
    ...
    public class MAPScript
    {
        ...
        /// </summary>
        public MAPData LevelData { get; internal set; } = new MAPData();
        ...
        /// </summary>
        private Dictionary<MAPContextDefinition, int> referencedContexts { get; } = new Dictionary<MAPContextDefinition, int>();
        /// <summary>
